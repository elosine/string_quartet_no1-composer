...
\score {
  ...
  }
  {
    ...
    ^\markup {
      ...
      \path #0.15
      #'(
          (moveto 0.6 -1) ;moveto A B - Bottom change B&D; Left change A&G
          (lineto 3 -1) ;lineto C D - Right C&E
          (lineto 3 9.5) ;lineto E F - Top change F&H
          (lineto 0.6 9.5) ;lineto G H
          (closepath)
          )
    }
