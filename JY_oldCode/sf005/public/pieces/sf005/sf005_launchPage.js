...
let launchBtn = mkButton({
  ...
  action: function() {
    if (launchBtnIsActive) {
      location.href = "/pieces/sf005/sf005.html?parts=" + partsToRunAsString + "&id=" + pieceIdString + "&sdfile=" + scoreDataFileNameToLoad + "&ctls=" + scoreControlsString; //this is the string that will be sent as URL arg
    }
  }
});
