...
\score {
  \new Staff \with {
    ...
    \override StaffSymbol.stencil = #(lambda (grob)
                                       (let* ((staff-space (ly:staff-symbol-staff-space grob))
                                              ...
                                              (width 0.65)  ; staff line width in mm
                                              ;///////////////////////////////////////
  ...
  }
  {
    ...
    % --- THE MUSIC ---
    \once \override NoteColumn.X-offset = #-1.7
    
    < % Open Chord
    
    \tweak NoteHead.extra-offset #'(0 . 0) f
    ...
    ^\markup {
      ...
      \path #0.15
      #'(
          (moveto 0.6 -1) ;moveto A B - Bottom change B&D
          (lineto 2.9 -1) ;lineto C D - Right C&E
          (lineto 2.9 5.5) ;lineto E F - Top change F&H
          (lineto 0.6 5.5) ;lineto G H - Left change A&G
          (closepath)
          )
    }
