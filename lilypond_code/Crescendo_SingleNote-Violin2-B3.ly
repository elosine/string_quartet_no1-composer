...
\paper{
  tagline = ##f
  paper-width = 21\mm %adjust paper-width,line-width @bottom, and \time 4/4 to get proper display width
  paper-height = 25\mm
  top-margin = 0\mm
  bottom-margin = 0\mm
  left-margin = 1\mm
...
\score {
    ...
    #( lambda (grob)
       (let*
        ((staff-space (ly:staff-symbol-staff-space grob))
         ...
         (width 2.6) ;staff line width in mm
  ...
  }
  {
    ...
    \override Hairpin.Y-offset = #-1  % Move hairpin y
    ...
    % Hairpin
    -\tweak extra-offset #'(-0.8 . 1.2)  % X,Y offset in staff spaces
    -\tweak shorten-pair #'(0 . 7)    % (left . right) - positive=shorter
    \<
    
    % Non-Vib Text
    -\tweak extra-offset #'(0 . -0.6)  % X,Y offset in staff spaces
    ^\markup {
    ...
    % Spacer
    s2\! % \! is the hairpin terminator
    
     % Secco Text
    -\tweak extra-offset #'(-5.6 . -1.9)
    _\markup {
      \override #'(font-name . "Crimson Pro Light Italic")
      \fontsize #-6
      "secco"
