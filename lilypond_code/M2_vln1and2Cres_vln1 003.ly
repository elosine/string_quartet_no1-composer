  ...
  \score {
    ...
    <<
...

      {
        ...
        e'''\ppp\<^\glissando^\markup { 
          \override #'(font-name . "Crimson Pro Light Italic") 
          \fontsize #-6 
          "Non-Vib" 
        } 
        
        % Manually hiding the target note to finish the glissando
        ...
        eeh'''2\! ^\markup {
          \override #'(font-name . "Crimson Pro Light Italic")
          \fontsize #-6
          % Using a drawn polygon for the arrow to ensure it shows up
          \concat { "1/4 tone " \raise #0.5 \smaller \draw-line #'(0 . -1) \arrow-head #Y #DOWN ##t }
        }
