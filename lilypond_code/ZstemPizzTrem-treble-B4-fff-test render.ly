...
% =====================================================================
% Knobs:
%   z-bar-width:  total horizontal extent of each bar (wider/narrower, always centered)
%   z-bar-height: line thickness of each bar (taller/shorter, slant angles maintained)
%   z-y-offset:   shift entire Z shape up (negative) or down (positive) on the stem
% Fixed:
%   z-bar-vpos:   vertical distance from Z center to bar outer edge
%   z-nib-ratio:  slant angle ratio (change only to adjust the / angle)
%   z-diag-thick: stroke thickness of the diagonal connecting line
%   z-diag-nudge: shift diagonal endpoints outward (top more -X, bottom more +X)
#(define z-bar-width 1.1)
#(define z-bar-height 0.4)
#(define z-y-offset -0.7)
