...
% ╔════════════════════════════════════════════════════════════════════════════╗
% ║  Z-Stem Pizzicato Tremolo — Wedge (Cresc→Decresc) Hairpin Test          ║
% ║  Pitch: B4, Dynamic: fff, Clef: treble, Hairpin: wedge                  ║
% ╚════════════════════════════════════════════════════════════════════════════╝
...
\score {
  ...
  }
  {
    ...
    % Crescendo hairpin (first half of wedge)
    -\tweak extra-offset #'(-0.8 . 0)
    \<

    % Midpoint — end cresc, start decresc
    s4\!\>
